...
### Performance
- **Адаптивный размер пула** — размер Player-пула теперь определяется автоматически по классу устройства: low — 2, medium — 3, high — 5. На мощных устройствах (Android SDK 31+, iPhone 11+) предзагружаются до 3 видео вперёд, обеспечивая мгновенные свайпы.
